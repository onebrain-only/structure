...
Before you report this task complete, append to `agent/status/junior-frontend-3b.md` — **`agent/WORKFLOWS.md` §1 rule 5**, which binds every agent and states what the entry must carry. Create the file if it does not exist.
