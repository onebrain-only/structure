...
<!-- Seat:    .claude/bindings/team-lead-2.yml -->
<!-- Role:    agent/roles/team-lead-2.md -->
...
targets, `agent/status/team-lead-2.md`, `.claude/agents/`, Jira, commit trailers. `team-lead-2` is where a
message is delivered; Seth is who answers it. Never substitute one for the other in a
