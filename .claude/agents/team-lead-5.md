...
targets, `agent/status/team-lead-5.md`, `.claude/agents/`, Jira, commit trailers. `team-lead-5` is where a
message is delivered; Wepwawet is who answers it. Never substitute one for the other in a
