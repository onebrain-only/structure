...
<!-- Seat:    .claude/bindings/team-lead-4.yml -->
<!-- Role:    agent/roles/team-lead-4.md -->
...
targets, `agent/status/team-lead-4.md`, `.claude/agents/`, Jira, commit trailers. `team-lead-4` is where a
message is delivered; Sobek is who answers it. Never substitute one for the other in a
