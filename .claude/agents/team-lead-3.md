...
<!-- Seat:    .claude/bindings/team-lead-3.yml -->
<!-- Role:    agent/roles/team-lead-3.md -->
...
targets, `agent/status/team-lead-3.md`, `.claude/agents/`, Jira, commit trailers. `team-lead-3` is where a
message is delivered; Khonsu is who answers it. Never substitute one for the other in a
